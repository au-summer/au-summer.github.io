...
<!-- ## Current Research -->
<!---->
<!-- **PhoenixML** - A system that provides fine-grained fault recovery for distributed GPU training. By designing a proxy context mechanism that separates GPU memory management from execution context, PhoenixML achieves sub-iteration recovery (milliseconds) with minimal work loss, compared to checkpoint-based approaches that take minutes and discard all work since the last checkpoint. -->
<!---->
<!-- **CudaProxy** - A CUDA runtime proxy for ML inference that separates dispatch policy from execution mechanism. By routing static operations through CUDA Graphs and dynamic operations through persistent GPU workers, CudaProxy reduces tail latency by over 30% compared to unfused baselines while approaching hand-tuned fusion performance. -->
...
Feel free to reach out to me at [ausummer@umich.edu](mailto:ausummer@umich.edu).
